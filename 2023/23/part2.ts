...
const connectGraph = (graph: Map<string, Node>) => {
...
const iFindLongestDistances = (
  start: Node,
  end: Node,
  graph: Map<string, Node>
) => {

  let paths: Path[] = [{nodes:[start.id], weight: 0}]
  let results: Path[] = []
